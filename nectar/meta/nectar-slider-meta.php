    ...
    $meta_box = array(
		...
		'fields' => array(
			...
			array( 
					...
					'desc' => __('This is the image that will be seen while the video is loading/before it is played.', NECTAR_THEME_NAME),
					'id' => '_nectar_slider_preview_image',
					'type' => 'file',
					'std' => ''
				),	
			array(
					'name' =>  __('Add texture overlay to video', NECTAR_THEME_NAME),
					'desc' => __('If you would like a slight texture overlay on your video, activate this option.', NECTAR_THEME_NAME),
